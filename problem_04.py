...
class Bank:
    ...
    def transfer(self, from_account, to_account, amount):
        if from_account.get_balance() >= amount:  # Faltou verificacao para saber se a conta de origem tem saldo suficiente. Agora o saldo é checado antes da transferência.
